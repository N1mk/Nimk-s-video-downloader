...
5. Вставьте путь до папки "nvd-extension-chrome"

* #### Установка расширения (firefox):
1. Откройте браузер на основе firefox
2. Перейдите по ссылке about:debugging
3. Перейдите в меню "Этот Firefox"
4. Найдите кнопку "Загрузить временное дополнение..."
5. Перейдите в папку "nvd-extension-chrome" и выберите любой файл (например, manifest.json)

* #### Установка приложения:
1. Запустите файл "video-downloader-build.exe"
2. Подождите несколько минут (первый запуск идёт долго из-за установки зависимостей)
3. С этого момента приложение должно запуститься и добавиться в автозагрузку
