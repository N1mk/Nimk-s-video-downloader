...
2. Запустите файл "video-downloader-build.exe"
3. Подождите несколько минут (первый запуск идёт долго из-за установки зависимостей)
4. С этого момента приложение должно запуститься и добавиться в автозагрузку

* *В случае возникновения ошибок обновите загрузчик через настройки расширения и проверьте файл логов по пути "video-downloader-app/app.log" или откорйте его с помощью расширения*
