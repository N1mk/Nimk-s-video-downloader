...
4. Откройте в проводнике папку с загруженым файлом "nvd-extension-chrome.crx"
...
4. Перейдите в папку "nvd-extension-chrome" и выберите любой файл (например, manifest.json)
